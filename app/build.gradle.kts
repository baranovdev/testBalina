...
android {
    namespace = "by.baranovdev.testbalina"
    compileSdk = 34

    defaultConfig {
        applicationId = "by.baranovdev.testbalina"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        release {
            ...
            val baseUrl = properties["by.baranovdev.testBalina.baseUrl"].toString()
        ...
        debug {
            isMinifyEnabled = false
            val baseUrl = properties["by.baranovdev.testBalina.baseUrl"].toString()
            val databaseVersion = properties["by.baranovdev.testBalina.databaseVersion"].toString()
            val yandexMapsApiKey = properties["by.baranovdev.testBalina.yandexMapKit.apiKey"].toString()
